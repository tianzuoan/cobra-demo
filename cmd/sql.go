...
import (
	...
	"github.com/tianzuoan/cobra-demmo/internal/sql2struct"
	"log"
)
...
var sql2structCmd = &cobra.Command{
	...
	Run: func(cmd *cobra.Command, args []string) {
		...
		err = template.Generate(tableName, templateColumns, path)
		if err != nil {
...
func init() {
	...
	sql2structCmd.Flags().StringVarP(&path, "path", "", "", "请输入结构体生成路径")
	sql2structCmd.Flags().StringVarP(&packageName, "package", "", "model", "请输入结构体包名称")
}
